...
def generateCharacter():
    ...
    output = {
        ...
        "Age": charAgeChoice,
        "Race": "",
        "Sex": charSexList[charSexChoice],
        "Alignment": charLawfulOrChaoticList[charLawfulOrChaoticChoice] + " " + charGoodOrEvilList[charGoodOrEvilChoice],
        "Stats": "S{:+d} D{:+d} C{:+d} I{:+d} W{:+d} C{:+d}".format(charStatStrengthMod, charStatDexterityMod, charStatConstitutionMod, charStatIntelligenceMod, charStatWisdomMod, charStatCharismaMod),
        "Class/Ocupation": charClassList[charClassChoice],
        "Height": heightFormat(charHeightChoice),
        "Build": charBuildList[charBuildChoice],
        "Appearance": charAppearanceList[charAppearanceChoice],
        "Talent": charTalentList[charTalentChoice],
        "Mannerism": charMannerismList[charMannerismChoice],
        "Interaction": charInteractionList[charInteractionChoice],
        "Useful Knowledge": "",
        "Ideal": charIdealChoice,
        "Bond": charBondList[charBondChoice],
        "Flaw/Secret": charFlawList[charFlawChoice],
        "Description": ""
    }
    return output
